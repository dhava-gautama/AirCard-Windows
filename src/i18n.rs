...
pub fn t(lang: Lang) -> T {
    match lang {
        Lang::En => T {
            ...
            transit_hint: "Transit card not found? Wallet → card → … → Card Details → Turn on Service Mode, then Scan.",
        ...
        Lang::Id => T {
            ...
            save_original: "Simpan asli",
            restore_original: "Pulihkan asli",
            transit_hint: "Kartu transit tidak ketemu? Wallet → kartu → … → Detail Kartu → Nyalakan Mode Layanan, lalu Pindai.",
